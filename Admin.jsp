         ...
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-12 col-lg-5">
                  <div class="about_img">
                     <figure><img src="images/admin.png" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-12 col-lg-7">
                  <div class="titlepage">
                      <h2 style="margin-bottom: 3%;"> Welcome TO Admin Login <br><span class="yellow">LOGIN</span> </h2>
                      
	<form action="Admin" method="post" style="margin-left: 8%">
