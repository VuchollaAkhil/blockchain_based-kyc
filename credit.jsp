                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="transaction.jsp">Transfer</a>
                                 </li>
                                 <li class="nav-item">
         ...
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-12 col-lg-5">
                  <div class="about_img">
                     <figure><img src="images/deb.png" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-12 col-lg-7">
                  <div class="titlepage">
                      <h2 style="margin-bottom: 3%;"> Your Transaction are Secure <br><span class="yellow">Credit</span> </h2>
...
<tr><td>Account No:</td>
<td><input type="text" name="accountno" value="<%=accounno%>" required="required"></td></tr>
<tr><td>Name:</td>
<td><input type="text" name="name" value="<%=name%>" required="required"></td></tr>


<tr><td>Email:</td>
<td><input type="email" name="email" value="<%=email%>" required="required"></td></tr>

<tr><td>Mobile No:</td>
<td><input type="text" name="mobile" value="<%=mobile%>" required="required"></td></tr>
...
<td><input type="number" name="damount" required="required"></td></tr>
<tr><td><button>Deposit</button>
